!function (n) {
    !function () {
        for (var n = 0, i =[
            "ms", "moz", "webkit", "o"
        ], a = 0; a < i.length && !window.requestAnimationFrame; ++ a) 
    ...
    n.fn.sakura = function (i) {
        ...
        var d = function () {
            ...
            var o = i.blowAnimations[Math.floor(Math.random() * i.blowAnimations.length)],
                ...
                l = "fall " + m + "s linear 0s 1, " + o + " " + (
                    (
                        m > 30
                            ? m
                            : 30
                    ) - 20 + a(0, 20)
                ) + "s linear 0s infinite, " + e + " " + a(2, 4) + "s linear 0s infinite",
                u = w.clone(),
